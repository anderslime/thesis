...
\begin{figure*}[ht!]
  \centering
  \includegraphics[width=0.6\linewidth]{figures/declaration-dependence-graph.png}
...
\begin{figure*}[ht!]
  \centering
  \includegraphics[width=0.8\linewidth]{figures/ddg-data-structure.png}
...
\begin{figure*}[ht!]
  \centering
  \includegraphics[width=1.0\linewidth]{figures/declaration-dependency-registration.png}
...
\begin{figure*}[ht!]
  \centering
  \includegraphics[width=1.0\linewidth]{figures/instance-dependency-registration.png}
...
\begin{figure*}[ht!]
  \centering
  \includegraphics[width=1.0\linewidth]{figures/invalidation-propagation.png}
  \begin{enumerate}
...
If the notification is delivered more than once we will just achieve a worse cache hit rate and affect performance, but it will not affect the integrity of the cache object. We must therefore monitor and ensure At-Least-Once semantics of the notification.
