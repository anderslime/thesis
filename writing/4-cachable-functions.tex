...
\section{Discussion on Limitations of Cachable Functions}
...
% TODO: Write about that the results which can be cached relies on the implementation and what is possible to serialize/deserialize into the cache.
