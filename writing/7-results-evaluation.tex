...
% TODO: Evaluate fault-tolerance
% - We ensure integrity using the timestamp invalidation technique
% - A degree of reliability ensured by having a simple architecture with few SPF's - the queueing system + the cache database
% - Maintainability ensured by simple system with a well-tested library.
