...
\begin{figure*}[ht!]
  \centering
  \includegraphics[width=1.0\linewidth]{figures/test-multi-deps.png}
...
\begin{figure*}[ht!]
  \centering
  \includegraphics[width=0.1\linewidth]{figures/test-nested-deps.png}
