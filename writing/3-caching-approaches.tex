...
\begin{figure*}[ht!]
  \centering
  \includegraphics[width=1.0\linewidth]{figures/timeline/trigger-based-with-background-update.pdf}
...
% section trigger_based_invalidation_with_background_update end

% TODO: Tell about how we can track whether a key is valid.
%  - We can use meta-information?
%  - But then what about race-conditions? Where to place this chapter?
