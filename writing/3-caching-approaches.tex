...
\begin{table}[htpb]
  ...
  \begin{tabular}{lcccccc}
                                          & Consistency & Freshness & \parbox{1.5cm}{In-place\\Updates} & \parbox{1cm}{Immediate\\Response} & Management & Adaptability \\
  \hline
  \emph{Arbitrary Content}                & & & & & & \\
  Expiration-based                        & maybe? & yes? & no? & yes? & maybe? & medium? \\
  Key-based                               & maybe? & yes? & no? & yes? & maybe? & medium? \\
  Manual Trigger-based                    & maybe? & yes? & no? & yes? & maybe? & medium? \\
  \parbox{2.5cm}{Manual Trigger-based\\with Async Update}  & maybe? & yes? & no? & yes? & maybe? & medium? \\
  Write-Trough                            & maybe? & yes? & no? & yes? & maybe? & medium? \\
  \parbox{2.5cm}{Transactional\\Consistency}  & maybe? & yes? & no? & yes? & maybe? & medium? \\
  \parbox{2.5cm}{Managing Cache\\Consistency} & maybe? & yes? & no? & yes? & maybe? & medium? \\
  \hline
  \emph{Declared Content}            & & & & & & \\
  \end{tabular}
  \caption{Comparison of caching approaches}
  \label{fig:existing-solutions-comparison}
\end{table}
