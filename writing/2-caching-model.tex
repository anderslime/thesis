...
% TODO: Also mention 'locality' here
...
% TODO: Maybe write about cleanup (removing unused values)
...
% TODO: Write observations about the timeline mode:
%  - If the valid interval is always full => Immediate response time
%  - If the fresh and valid interval is equal => Consistency
%    - Or: at places where they are equal/overlapping we have consistency
...
% TODO: Rename this to relaxed freshness
