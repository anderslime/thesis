...
\include{2-caching-approaches}
\include{3-automatic-cache-invalidation}
\include{4-data-update-propagation}
\include{5-persistent-cache}
\include{6-cachable-functions}
